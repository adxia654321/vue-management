...
const save = async () => {
    ...
    clazzFormRef.value.validate(async (valid) =>{  // valid 表示是否驗證通過 true通過 false不通過
      if(valid){
...
<h1>班級管理</h1>
    ...
    <div class="container">
        <el-table :data="clazzList" border style="width: 100%">
            ...
            <el-table-column prop="name" label="班級名稱" width="260" align="center"/>
    ...
    <el-form :model="clazz" :rules="rules" ref="clazzFormRef">
      <el-form-item label="班級名稱" label-width="80px" prop="name">
